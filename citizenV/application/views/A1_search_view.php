                ...
                <div class="content">
                    <div class="content_list">
                        <ul class="content_menu">
                            ...
                            <li class="content_menu-option">
                                <a href="http://localhost/citizenV/index.php/A1_controller/analysis">
                    ...
                    <form method="post" enctype="multidata/form-data" action="http://localhost/citizenV/index.php/A1_controller/searchCitizen">
                    <div class="content_board">
                        <div class="content_board-search">
                            <label for="search">Tìm kiếm công dân : </label>
