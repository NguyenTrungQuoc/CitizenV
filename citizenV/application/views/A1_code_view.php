...
<head>
    <meta charset="UTF-8">
    <title>Tra cứu mã tỉnh/thành phố</title>
        ...
        <div class="grid">
                ...
                <div class="header">
                    <div class="col">
                        <ul class="header_list">
                            <li>
                                <a href="http://localhost/citizenV/index.php/A1_controller/home">
                                    <p class="header_icon"><i class="fas fa-house-damage"></i></p>
                                    Trang chủ
                                </a>
                            </li>
                            <li>
                                <a class="active" href="http://localhost/citizenV/index.php/A1_controller/listCode">
                                    <p class="header_icon"><i class="fas fa-external-link-alt"></i></p>
                                    Tra cứu mã
                                </a>
                            </li>
                            <li>
                                <a href="http://localhost/citizenV/index.php/A1_controller/account">
                        ...
                        <div class="log-out"> 
                            ...
                            <label class="log-out-pc" for="">
                                <p class="header_icon"><i class="far fa-user"></i></p>
                                 <?php echo $this->session->userdata('tendangnhap'); ?>
                ...
                <div class="content">
                    <div class="content_list">
                        <ul class="content_menu">
                            <li class="content_menu-option">
                                <a  href="http://localhost/citizenV/index.php/A1_controller/list">
                                    <i class="fab fa-algolia"></i>
                                    Danh sách công dân</li>
                                </a>
                            </li>
                            <li class="content_menu-option">
                                <a  href="http://localhost/citizenV/index.php/A1_controller/search">
                                    <i class="fab fa-algolia"></i>
                            ...
                            <li class="content_menu-option">
                                <a class="" href="http://localhost/citizenV/index.php/A1_controller/analysis">
                    ...
                    <div class="content_board">
                        <table style="width:100%" class="content_table pages">
                            <tr>
                        ...
                        <div class="content_next">
                            ...
                            <a href=""><div class="content_next-list">1</div></a>
