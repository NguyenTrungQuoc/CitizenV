...
<head>
    <meta charset="UTF-8">
    <title>Cấp tài khoản cán bộ Tỉnh/Thành phố</title>
...
<body> 
    <div class="app">
        <div class="grid">
                ...
                <form method="post" enctype="multidata/form-data" action="http://localhost/citizenV/index.php/A1_controller/addA2">
                <div class="content">
                    <div class="content_account">
                        <h1>Cấp tài khoản cán bộ Tỉnh/Thành phố (A2)</h1>
                        <div class="content_account-new">
                            <div class="content_account-text">
                                
                                <div class="content_account-input">
                                    <label for="code">Mã tỉnh/thành phố:</label>
