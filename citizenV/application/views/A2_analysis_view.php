                ...
                <div class="content">
                    <div class="content_list">
                        <ul class="content_menu">
                            ...
                            <li class="content_menu-option">
                                <a class="active" href="http://localhost/citizenV/index.php/A2_controller/analysis">
                                    <i class="fas fa-calendar-alt"></i>
                                    Phân tích số liệu </li>
                                </a>
                            </li>
                            <li class="content_menu-option">
                                <a href="http://localhost/citizenV/index.php/A2_controller/complete">
                            ...
                            <li class="content_menu-option">
                                <a href="http://localhost/citizenV/index.php/A2_controller">
                                    <i class="fas fa-calendar-check"></i>
