...
<head>
    <meta charset="UTF-8">
    <title>Tra cứu mã quận/huyện</title>
                ...
                <div class="header">
                    <div class="col">
                        <ul class="header_list">
                            <li>
                                <a href="http://localhost/citizenV/index.php/A3_controller/home">
                                    <p class="header_icon"><i class="fas fa-house-damage"></i></p>
                                    Trang chủ
                                </a>
                            </li>
                            <li>
                                <a class="active" href="http://localhost/citizenV/index.php/A3_controller/listCode">
                                    <p class="header_icon"><i class="fas fa-external-link-alt"></i></p>
                                    Tra cứu mã
                                </a>
                            </li>
                            <li>
                                <a href="http://localhost/citizenV/index.php/A3_controller/account">
                    ...
                    <div class="content_list">
                        <ul class="content_menu">
                            <li class="content_menu-option">
                                <a  href="http://localhost/citizenV/index.php/A3_controller/list">
                                    <i class="fab fa-algolia"></i>
                                    Danh sách công dân</li>
                                </a>
                            </li>
                            <li class="content_menu-option">
                                <a  href="http://localhost/citizenV/index.php/A3_controller/search">
                                    <i class="fab fa-algolia"></i>
                            ...
                            <li class="content_menu-option">
                                <a class="" href="http://localhost/citizenV/index.php/A3_controller/analysis">
