...
<body>
    ...
    <div class="app">
        <div class="grid">
                ...
                <div class="header">
                    <div class="col">
                        <ul class="header_list">
                            ...
                            <li>
                                <a href="http://localhost/citizenV/index.php/A3_controller/listCode">
                ...
                <form method="post" enctype="multidata/form-data" action="http://localhost/citizenV/index.php/A3_controller/addB1">
                <div class="content">
                    <div class="content_account">
                        <h1>Cấp tài khoản cán bộ B1</h1>
                        <div class="content_account-new">
                            <div class="content_account-text">
                                <div class="content_account-input">
                                    <label for="name">Mã cán bộ B1:</label>
                            ...
                            <div class="content_account-img">
                                <label for="imgs">Ảnh:</label>
                                <div class="content_account-boximg"></div>
                            </div>
                        </div>
                        <div class="content_icondown">
                            <i class="fas fa-arrow-down"></i>
                        </div>
                        <input class="content_accounta3" type="submit" placeholder="Done" name="Done">
                    </div>
                </div>
                <footer>
