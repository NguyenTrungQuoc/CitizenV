                ...
                <div class="content">
                    <div class="content_list">
                        <ul class="content_menu">
                            ...
                            <li class="content_menu-option">
                                <a class="active" href="http://localhost/citizenV/index.php/B1_controller/search">
                                    <i class="fab fa-algolia"></i>
                            ...
                            <li class="content_menu-option">
                                <a href="http://localhost/citizenV/index.php/B1_controller">
                                    <i class="fas fa-calendar-check"></i>
                    ...
                    <form method="post" enctype="multidata/form-data" action="http://localhost/citizenV/index.php/B1_controller/searchCitizen">
