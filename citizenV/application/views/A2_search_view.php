    ...
    <div class="app">
        <div class="grid">
                ...
                <div class="content">
                    <div class="content_list">
                        <ul class="content_menu">
                            <li class="content_menu-option">
                                <a  href="http://localhost/citizenV/index.php/A2_controller/list">
                            ...
                            <li class="content_menu-option">
                                <a class="active" href="http://localhost/citizenV/index.php/A2_controller/search">
                                    <i class="fab fa-algolia"></i>
                    ...
                    <form method="post" enctype="multidata/form-data" action="http://localhost/citizenV/index.php/A2_controller/searchCitizen">
